...
var base = Rebase.createClass({
  apiKey: "AIzaSyBxMCeCeY14U7gh9cUb03MSfIRYHIVu2Ak",   // replace with your Firebase application's API key
  databaseURL: "https://final-e4c8f.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    var movieSort = this.state.movies
    if (view === 'alpha') {
      movieSort = movieData.sort(this.movieCompareByTitle)
    } else if (view === 'latest'){
      movieSort = movieData.sort(this.movieCompareByReleased)
    }
    this.setState({
      currentView: view,
      movies: movieSort
  ...
  render: function() {
    return (
      <div>
        ...
        <SortBar movieCount={this.state.currentView} currentView={this.state.currentView} viewChanged={this.viewChanged} />
